...
class MyModel(Model):
    ...
    def __init__(self):
        ...
        self.conv1 = Conv2D(filters=1, kernel_size=kernel_size, padding="same")
        self.bn1 = BatchNormalization()
        self.ac1 = Activation(tf.nn.relu)
        self.pool1 = MaxPool2D(pool_size=(16, 16))

        # self.conv2 = Conv2D(filters=1, kernel_size=kernel_size, padding="same")
        # self.bn2 = BatchNormalization()
        # self.ac2 = Activation(tf.nn.relu)
        # self.pool2 = MaxPool2D(pool_size=(2, 2))
        #
        # self.conv3 = Conv2D(filters=1, kernel_size=kernel_size, padding="same")
        # self.bn3 = BatchNormalization()
        # self.ac3 = Activation(tf.nn.relu)
        # self.pool3 = MaxPool2D(pool_size=(2, 2))
        #
        # self.conv4 = Conv2D(filters=1, kernel_size=kernel_size, padding="same")
...
# tensorboard --logdir='/Users/wql/PycharmProjects/learning/MLAlgrithom/Kaggle/SIIM-ISIC_Melanoma_Classification/logs' --port=8008
